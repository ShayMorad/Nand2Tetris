...
class CodeWriter:
    ...
    def write_if(self, label: str) -> None:
        ...
        self.output_stream.write("@SP\n"
                                 ...
                                 "D=M\n"  # D HAS POP VALUE
                                 "@SP\n"
                                 "M=M-1\n" # DELETE LAST VALUE IN STACK BECAUSE OF POP
                                 "@"+ self.cur_func + "$" + label + "\n"
                                 "D;JNE\n")
    ...
    def write_function(self, function_name: str, n_vars: int) -> None:
        ...
        self.output_stream.write("("+ self.cur_func+")\n")
    ...
    def write_call(self, function_name: str, n_args: int) -> None:
        ...
        self.output_stream.write(
            "@" + self.cur_func + "$ret." + str(self.call_count) + "\n"
            "D=A\n"          # D has address of (return_address)                             
            "@SP\n"
            "A=M\n"
            "M=D\n"          # set last item in stack to be D 
            "@SP\n"
            "M=M+1\n"        # move SP to be SP+1
        ...
        self.output_stream.write("("+self.cur_func + "$ret." + str(self.call_count) + ")\n")
    ...
    def write_return(self) -> None:
        ...
        self.output_stream.write(
            ...
            "D=M\n"
            "@R14\n"
            "M=D\n" # R14 has return_address which is *(frame-5)
